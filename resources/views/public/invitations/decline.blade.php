            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 offset-lg-3 offset-xl-3">
                    <div class="form-wrapper">
                        ...
                        <form id="registerFormFree" action="{{ route('public.invitations.decline', ['slug' => $invite->slug]) }}" method="POST">
                            @csrf
                            <p>
                                You are about to cancel your invitation. Please click the button below to decline the invitation.
                            </p>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="submit-info" id="submitBtnArea">
                                        <button class="btn2 w-100" type="submit" id="payBtn">Decline</button>
                                    </div>
                                </div>
                            </div>
                        </form>
