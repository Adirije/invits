        ...
        <section class="card card-danger card-outline">
            ...
            <div class="card-body" id="composeArea">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col">
                        <input type="text" name="endDate" form="createForm" id="endDate" class="form-control" placeholder="End Date">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="btn btn-default btn-file">
                        ...
                        <input type="file" form="createForm" accept="image/*" id="featurePhoto" name="featureImage" >
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input form="createForm" type="checkbox" name="major" class="custom-control-input" id="major">
