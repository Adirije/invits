<div class="modal fade" id="editIncomeModal" tabindex="-1" role="dialog" aria-labelledby="editIncomeModalTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card card-widget widget-user-2 border-0 shadow-none">
                    <form class="editIncomeForm" id="editIncomeForm">
                        @csrf
            ...
            <div class="modal-footer">
                ...
                <div id="submitBtnAreaEdit">
                    <button type="submit" form="editIncomeForm" class="btn btn-sm btn-danger">Save</button>
                </div>
            </div>
        </div>
    </div>
